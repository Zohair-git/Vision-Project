...
<div id="wrapper">
 ...
 <!--Start sidebar-wrapper-->
  ...
  <ul class="sidebar-menu do-nicescrol">
     ...
     <li>
       <a href="insertitems.php">
         <i class="zmdi zmdi-format-list-bulleted"></i> <span>Insert Items</span>
       </a>
     </li>

     <li>
       <a href="Addcomponentcat.php">
         <i class="zmdi zmdi-format-list-bulleted"></i> <span>Add Componenets</span>
       </a>
     </li>
